...
import numpy as np
import data_loader
from data_loader import train_input_fn
from data_loader import eval_input_fn
...
def cloud_training(args)-> None:  
    ...
    test_dataset = eval_input_fn(args)
