...
def input_fn(params, mode):
    dataset_dir = os.path.expanduser(params['train_dir'])
    train_dataset, test_dataset = load_train_dataset(dataset_dir, params)
...
def train_input_fn(params):
    return input_fn(params, tf.estimator.ModeKeys.TRAIN)

def eval_input_fn(params):
    return input_fn(params, tf.estimator.ModeKeys.EVAL)
